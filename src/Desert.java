...
public class Desert extends PipelineElement {
    ...
    public static void setup(Object obj, ArrayList<String> options) {
        ...
        // view setup
        DesertView desertView = new DesertView((Desert)obj);
        ((Desert) obj).setView(desertView);
        ((Desert) obj).addView(desertView);
    }
