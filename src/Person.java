 ...
 */
public abstract class Person extends Sprite implements Tickable{
    /**
     ...
     * @return  Sikeres volt-e a művelet.
     */
    public boolean pickUpPipe(int idx){return false;}
    /**
     * Leszármazotthoz tartozó függvény. Plumber valósítja meg.
     * @param idx   A felvenni szánt cső indexe.
     * @return  Sikeres volt-e a művelet.
     */
    public boolean pickUpPipeEnd(int idx){return false;}
    /**
     * Leszármazotthoz tartozó függvény. Plumber valósítja meg.
     * @return  Sikeres volt-e a művelet.
     */
    public boolean pickUpPump(){return false;}
    /**
