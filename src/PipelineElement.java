 ...
 */
public abstract class PipelineElement extends Sprite {
    /**
    ...
    public ArrayList<PipelineElement> getNeighbors(){
        return neighbors;
    }
    ...
    /**
     * Csak a pumpa definiálja felül, visszaadja a bemeneti csövet.
     * @return bemeneti cső, itt null
     */
    public PipelineElement getNeighborOne() { return null; }

    /**
     * Csak a pumpa definiálja felül, visszaadja a kimeneti csövet.
     * @return kimeneti cső, itt null
     */
    public PipelineElement getNeighborTwo() { return null; }
