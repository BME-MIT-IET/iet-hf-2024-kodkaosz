...
public class WaterSource extends PipelineElement implements Tickable {
    ...
    private WaterSourceView waterSourceView;
    ...
    public static void setup(Object obj, ArrayList<String> options) {
        ...
        // view setup
        WaterSourceView waterSourceView = new WaterSourceView(Integer.parseInt(options.get(options.size() - 2)),
                Integer.parseInt(options.get(options.size() - 1)), (WaterSource)obj);
        ((WaterSource) obj).setView((waterSourceView));
        ((WaterSource) obj).addView(waterSourceView);
    }
    ...
    public SpriteView getView() {
        ...
        return waterSourceView;
    }

    public void setView(SpriteView view) {

        this.waterSourceView = (WaterSourceView)view;
    }
}
