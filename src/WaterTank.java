...
public class WaterTank extends PipelineElement implements Tickable {
    ...
    /**
     * A WaterTank objektumok megjelenítéséért felelős osztály egy példánya.
     */
    ...
    public static void setup(Object obj, ArrayList<String> params) {
        ...
        int x = Integer.parseInt(params.get(3));
        int y = Integer.parseInt(params.get(4));
        ((WaterTank) obj).addView(new WaterTankView(x, y, (WaterTank) obj));
    }
